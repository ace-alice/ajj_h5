...
.tiro-task-dialog {
  :deep(.van-popup) {
    width: 80%;
    background-image: linear-gradient(180deg, #78c0d3 0%, #ffffff 25%);
...
.tiro-task-dialog-footer {
  background-color: transparent !important;
  span {
    display: block;
    flex: none;
    margin: 0 auto;
    background-color: #54a5ba !important;
