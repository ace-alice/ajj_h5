<template>
  <div class="v-agent-list">
    <div class="v-agent-list-header">
      <van-icon
        name="arrow-left"
        @click.stop="toPath({ name: 'AgentReport' })"
      />
...
import AgentReportDetailItem from '@/components/AgentReportDetailItem/index.vue'
import toPathHook from '@/hooks/toPath'
import listAnimateHook from '@/hooks/listAnimate'

export default defineComponent({
  name: 'AgentReportDetail',
  components: { AgentReportDetailItem },
  setup() {
    const agent = ref('')
